...
import { sidebar, sidebarNonSuper } from "@/lib/utils";
...
const Sidebar = ({ setIsSidebar, isSidebar }) => {
  ...
  const sidebars =
    user?.user?.role == "super_admin" ? sidebar : sidebarNonSuper;
  ...
  return (
    <Box
      ...
      <Box className="relative">
        ...
        <Box className=" sticky bottom-0 w-full space-x-4 flex items-center p-4 ">
          <Button
            variant="secondary"
